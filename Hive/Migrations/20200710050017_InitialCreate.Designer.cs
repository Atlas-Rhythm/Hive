...
namespace Hive.Migrations
{
    ...
    [Migration("20200710050017_InitialCreate")]
            ...
            modelBuilder.Entity("Hive.Models.Mod", b =>
                {
                    ...
                    b.Property<List<ModReference>>("Conflicts")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<ModReference>>("Dependencies")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<ValueTuple<string, Uri>>>("Links")
                        .IsRequired()
                        .HasColumnType("jsonb");
