...
namespace Hive.Utilities
{
    ...
    public static class Extensions
    {
        ...
        /// <summary>
        /// Partitions the provided sequence using the provided <see cref="IPartitioner{T}"/>.
        /// </summary>
        /// <typeparam name="T">The element type of the sequence.</typeparam>
        /// <param name="seq">The input sequence to partition.</param>
        /// <param name="partitioner">The partitioner to use to partition that sequence.</param>
        /// <returns>A sequence of sequences generated by the partitioner.</returns>
