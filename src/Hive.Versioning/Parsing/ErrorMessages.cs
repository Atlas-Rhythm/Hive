...
namespace Hive.Versioning.Parsing
{
    ...
    public static class ErrorMessages
    {
        ...
        #region Version
        /// <summary>
        /// Gets a user-friendly error message for a <see cref="Version"/> parse.
        /// </summary>
...
#pragma warning restore IDE0072 // Add missing cases
        ...
        #region VersionRange
        /// <summary>
        /// Gets a user-friendly error message for a <see cref="VersionRange"/> parse, optionally automatically applying fixes
        /// and retrying for more error information.
        /// </summary>
        /// <param name="errors">The <see cref="ParserErrorState{TAction}"/> populated by the parser.</param>
